...
include 'C:/Anaconda/lib/site-packages/qutip/cy/complex_math.pxi'
...
def cy_td_ode_rhs(
    ...
    spmvpy(&data1[0], &idx1[0], &ptr1[0], &vec[0], zinterp(t, 0.0, 10.0, spline0), out, num_rows)
    spmvpy(&data2[0], &idx2[0], &ptr2[0], &vec[0], zinterp(t, 0.0, 10.0, spline1), out, num_rows)
